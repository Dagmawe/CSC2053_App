      ...
      <View style={styles.screen}>
        ...
        >
          <ScrollView style={styles.ScrollView}>
            ...
            <Text style={styles.info}>
              Low: {Math.round(this.state.low_temp * (9 / 5) + 32)} ° High:{" "}
              {Math.round(this.state.high_temp * (9 / 5) + 32)} °
            </Text>
            <View style={styles.container}>
              <Text style={styles.box}> Humidity: {this.state.humidity}%</Text>
            ...
            <View style={styles.container}>
              <Text style={styles.box} numberOfLines={2}>
                Sunrise {this.state.sunrise}AM
              </Text>

              <Text style={styles.box}>
                {""}
                Sunset {this.state.sunset}PM
              </Text>
            </View>
            <View style={styles.button}>
              <Button title="Reload" color="white" onPress={this.getWeather} />
            </View>
          </ScrollView>
        </ImageBackground>
      </View>
